...
const statusOptions = [
    ...
    { value: 'inprogress', label: 'In Progress', color: '#0092ff' },
...
const orderOptions = [
    { value: 'ascending', label: 'Ascending', color: '#0092ff' },
