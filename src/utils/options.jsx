...
const propsalStatusOptions = [
    ...
    { value: 'open', label: 'Open', color: "#0092ff" },
...
const customerListTagsOptions = [
    ...
    { value: 'team', label: 'Team', color: '#0092ff' },
    ...
    { value: 'wholesale', label: 'Wholesale', color: '#0092ff' },
...
const leadsGroupsOptions = [
    ...
    { value: "group-c", label: "Group-C", color: "#0092ff" },
    ...
    { value: "group-i", label: "Group-I", color: "#0092ff" },
    { value: "group-j", label: "Group-J", color: "#ea4d4d" },
    { value: "group-k", label: "Group-K", color: "#41b2c4" },
]

const taskStatusOptions = [
    { value: 'inprogress', label: 'Inprogress', color: '#0092ff' },
...
const taskPriorityOptions = [
    { value: 'low', label: 'Low', color: '#0092ff' },
...
const taskTypeOptions = [
    { value: 'new', label: 'New', color: '#0092ff' },
...
const projectStatusOptions = [
    { value: "in-projress", label: "In Projress", color: "#0092ff" },
...
const projectBillingOptions = [
    { value: "fixed-rate", label: "Fixed Rate", color: "#0092ff" },
...
const projectRoalOptions = [
    { value: "admin", label: "Admin", color: "#0092ff" },
